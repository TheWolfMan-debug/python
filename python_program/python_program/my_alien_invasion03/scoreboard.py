...
class Scoreboard():
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(
            high_score_str, True, self.text_color, "arial")
    ...
    def prep_alien_number(self):
        ...
        self.alien_number_image = self.font.render(
            "The number of Aliens: " + str(self.stats.alien_number), True, self.text_color, "arial")
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render(
            score_str, True, self.text_color, "arial")
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(
            "Level: " + str(self.stats.level), True, self.text_color, "arial")
